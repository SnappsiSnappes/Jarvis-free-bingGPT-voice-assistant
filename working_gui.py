# Это GUI интерфейс для создания команд
# - Чтобы пользоваться запустите скрипт
# Прежде чем создать команду внимательно прочитайте
# Инструкцию, графа - "Обратите внимание"
# Там я подробно описал с картинками как создавать команды
